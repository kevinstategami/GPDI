...
<div class="panel">
								...
								<form action="{{ url('dashboard/ringkasan/post') }}" method="POST" enctype="multipart/form-data">
									@csrf
								<div class="panel-body">													
									...
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input class="form-control" placeholder="Pembuat" type="text" name="pembuat" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
									</div>
									<br>	
